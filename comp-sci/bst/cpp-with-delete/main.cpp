...
void test_deletion() {
    ...
    std::cout << "\nInitial tree structure:" << std::endl;
    bst.printTree();

    // Test 1: Delete leaf node
    std::cout << "\nDeleting leaf node (25):" << std::endl;
    bool result = bst.remove(25);
    std::cout << "  Delete result: " << (result ? "success" : "failed") << std::endl;
    std::cout << "  25 exists: " << (bst.exists(25) ? "true" : "false") << std::endl;
    bst.printTree();

    // Test 2: Delete node with one child
    std::cout << "\nDeleting node with one child (60):" << std::endl;
    result = bst.remove(60);
    std::cout << "  Delete result: " << (result ? "success" : "failed") << std::endl;
    std::cout << "  60 exists: " << (bst.exists(60) ? "true" : "false") << std::endl;
    bst.printTree();
    ...
    std::cout << "  Delete result: " << (result ? "success" : "failed") << std::endl;
    std::cout << "  30 exists: " << (bst.exists(30) ? "true" : "false") << std::endl;
    bst.printTree();
    ...
    // Test 5: Try to delete non-existent node
    std::cout << "\nTrying to delete non-existent node (999):" << std::endl;
    result = bst.remove(999);
    std::cout << "  Delete result: " << (result ? "success" : "failed") << " (should be failed)" << std::endl;

    // Test 6: Verify remaining tree properties
